# Emare Desk — Hızlı Başlangıç (Developer Guide)
...
```bash
# Repo'ya gir
cd /Users/emre/Desktop/Emare/emare desk
...
| 6 | `emare desk_HAFIZA.md` | Proje geçmişi |
...
- **Derviş**: EmareAPI'de `emare desk Dervishi` bu projeden sorumlu
